...
class FaceMouthDao(metaclass=SingletonMeta):
    def load(self, *, seed_if_missing: bool = True, device_id: str | None = None) -> list[dict[str, Any]] | None:
        return _store.load_face_mouth_cfg_file(seed_if_missing=seed_if_missing, device_id=device_id)

    def save(self, groups: list[dict[str, Any]], *, device_id: str | None = None) -> None:
