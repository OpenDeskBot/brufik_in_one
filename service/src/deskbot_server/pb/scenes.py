...
def _load_design_scenes_rows(*, device_id: str | None = None) -> list[dict[str, Any]]:
...
def _prepare_pb_scene_chain_frames(scene_name: str, *, runtime_req: str, device_id: str | None = None) -> list[dict]:
